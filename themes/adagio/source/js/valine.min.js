...
!(function (e, t) {
  ...
  : 'function' == typeof define && define.amd ?
    define([], t)
  : 'object' == typeof exports ? (exports.Valine = t())
  : (e.Valine = t());
})(this, function () {
  return (function (e) {
    function t(r) {
    ...
    function (e, t, n) {
      ...
      var f = function () {
        ...
        D = {
          __proto__: null,
          '%AggregateError%':
            'undefined' == typeof AggregateError ? void 0
            : AggregateError,
          '%Array%': Array,
          '%ArrayBuffer%':
            'undefined' == typeof ArrayBuffer ? void 0 : (
              ArrayBuffer
            ),
          '%ArrayIteratorPrototype%':
            v && m ? m([][Symbol.iterator]()) : void 0,
          ...
          '%Atomics%':
            'undefined' == typeof Atomics ? void 0 : (
              Atomics
            ),
          '%BigInt%':
            'undefined' == typeof BigInt ? void 0 : BigInt,
          '%BigInt64Array%':
            'undefined' == typeof BigInt64Array ? void 0 : (
              BigInt64Array
            ),
          '%BigUint64Array%':
            'undefined' == typeof BigUint64Array ? void 0
            : BigUint64Array,
          '%Boolean%': Boolean,
          '%DataView%':
            'undefined' == typeof DataView ? void 0 : (
              DataView
            ),
          '%Date%': Date,
          '%decodeURI%': decodeURI,
          ...
          '%EvalError%': i,
          '%Float32Array%':
            'undefined' == typeof Float32Array ? void 0 : (
              Float32Array
            ),
          '%Float64Array%':
            'undefined' == typeof Float64Array ? void 0 : (
              Float64Array
            ),
          ...
          '%GeneratorFunction%': b,
          '%Int8Array%':
            'undefined' == typeof Int8Array ? void 0 : (
              Int8Array
            ),
          '%Int16Array%':
            'undefined' == typeof Int16Array ? void 0 : (
              Int16Array
            ),
          '%Int32Array%':
            'undefined' == typeof Int32Array ? void 0 : (
              Int32Array
            ),
          '%isFinite%': isFinite,
          '%isNaN%': isNaN,
          '%IteratorPrototype%':
            v && m ? m(m([][Symbol.iterator]())) : void 0,
          '%JSON%': 'object' == typeof JSON ? JSON : void 0,
          '%Map%': 'undefined' == typeof Map ? void 0 : Map,
          '%MapIteratorPrototype%':
            'undefined' != typeof Map && v && m ?
          ...
          '%parseInt%': parseInt,
          '%Promise%':
            'undefined' == typeof Promise ? void 0 : (
              Promise
            ),
          '%Proxy%':
            'undefined' == typeof Proxy ? void 0 : Proxy,
          '%RangeError%': o,
          '%ReferenceError%': a,
          '%Reflect%':
            'undefined' == typeof Reflect ? void 0 : (
              Reflect
            ),
          '%RegExp%': RegExp,
          '%Set%': 'undefined' == typeof Set ? void 0 : Set,
          '%SetIteratorPrototype%':
            'undefined' != typeof Set && v && m ?
              m(new Set()[Symbol.iterator]())
            : void 0,
          '%SharedArrayBuffer%':
            'undefined' == typeof SharedArrayBuffer ? void 0
            : SharedArrayBuffer,
          '%String%': String,
          ...
          '%TypeError%': s,
          '%Uint8Array%':
            'undefined' == typeof Uint8Array ? void 0 : (
              Uint8Array
            ),
          '%Uint8ClampedArray%':
            'undefined' == typeof Uint8ClampedArray ? void 0
            : Uint8ClampedArray,
          '%Uint16Array%':
            'undefined' == typeof Uint16Array ? void 0 : (
              Uint16Array
            ),
          '%Uint32Array%':
            'undefined' == typeof Uint32Array ? void 0 : (
              Uint32Array
            ),
          '%URIError%': l,
          '%WeakMap%':
            'undefined' == typeof WeakMap ? void 0 : (
              WeakMap
            ),
          '%WeakRef%':
            'undefined' == typeof WeakRef ? void 0 : (
              WeakRef
            ),
          '%WeakSet%':
            'undefined' == typeof WeakSet ? void 0 : (
              WeakSet
            ),
        };
      if (m)
        ...
        (0, p.default)(h.default, {
          ...
          dynamicLoadSource: function (e, t) {
            if (
              ...
              ((0, h.default)('head')[0].appendChild(n),
                (n.src = e));
            }
          },
          sdkLoader: function (e, t, n) {
            t in window && window[t] ?
              (S && clearTimeout(S), n && n())
            : h.default.dynamicLoadSource(e, function () {
                S = setTimeout(
                  h.default.sdkLoader(e, t, n),
                  100,
                );
              });
          },
    ...
    function (e, t, n) {
      ...
      ((t.DEFAULT_EMOJI_CDN =
        ...
        (t.CONFIG = {
          ...
          placeholder:
            '可以输入注册https://gravatar.com/时的邮箱以显示在gravatar中保存的头像（输入邮箱还能接收回复提醒哦）',
          pageSize: 20,
          recordIP: !0,
          serverURLs: '',
          visitor: !1,
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        return o(
          t,
          1 + d(0, e.length - (arguments.length - 1)),
          !0,
        );
      };
      var p = function () {
	...
	*/
      !(function (n, a) {
        ((i = [e, t]),
          ...
          void 0 !==
            (o =
              'function' == typeof r ? r.apply(t, i) : r) &&
            (e.exports = o));
      })(0, function (e, t) {
        'use strict';
        function n(e) {
    ...
    function (e, t, n) {
      ...
      ((i.prototype.init = function (e) {
        ...
        return (
          e &&
            ((e = k.default.extend(h.CONFIG, e)),
            (t.i18n = (0, d.default)(
              e.lang || k.default.lang,
              e.langMode,
            )),
            (t.cfg = e),
            (f.default.maps =
              (!!e.emojiMaps && e.emojiMaps) ||
              f.default.maps),
            (f.default.cdn =
              (!!e.emojiCDN && e.emojiCDN) ||
              f.default.cdn),
            t._init()),
          t
        );
      ...
      ((i.prototype.Q = function (e) {
        ...
        var u = JSON.stringify(arguments[1]).replace(
            /(\[|\])/g,
            '',
          ),
          s =
        ...
        (i.prototype.bind = function () {
          ...
          var e = this,
            ...
            c = function (e) {
              ...
              titles = titles.map((title, i) => {
                var start = a.findIndex(r =>
                  r.includes(title.title),
                );
                title.range = [
                  start,
                  i < hrCount.length ?
              ...
              for (var r in a) {
                if (
                  titles[titleIndex].hasPush &&
                  r > titles[titleIndex].range[1]
                ) {
                  titleIndex = Math.min(
                    titles.length - 1,
                    titleIndex + 1,
                    ...
                    function (r) {
                      (e.cfg.enableQQ &&
                        ...
                        : k.default.store.get(
                          ...
                          k.default.store.get(h.QQCacheKey)
                            .nick != n.val() &&
                          (k.default.store.remove(
                            h.QQCacheKey,
                          ),
                          (_.nick = n.val()),
                          (_.mail = ''),
          ...
          var j = function () {
              var e =
                  ...
                  : '',
                t =
                  /(https?:\/\/[a-zA-Z0-9\u4e00-\u9fa5][-a-zA-Z0-9\u4e00-\u9fa5.]*[a-zA-Z0-9\u4e00-\u9fa5](\/[-A-Za-z0-9+&@#/%?=~_|!:,.;]*)?(\?[a-zA-Z0-9&=]*)?)/g,
                n = e.match(t) || [];
          ...
          (!(function (t) {
            if (
              (t = k.default.store.get(h.MetaCacheKey) || t)
            )
              for (var n in p)
                if (p.hasOwnProperty(n)) {
                  ...
                  (e.$el
                    .find('.v' + r)
                    .val(k.default.unescape(t[r])),
                    (_[r] = t[r]));
                }
            var i = k.default.store.get(h.QQCacheKey);
            _.QQAvatar =
              (e.cfg.enableQQ && !!i && i.pic) || '';
          })(),
            (e.reset = function () {
              ((_.comment = ''),
                v.comment.val(''),
            ...
            Q = function () {
              ...
              (n.setACL(U()),
                n
                  ...
                  .then(function (t) {
                    'Anonymous' != _.nick &&
                      k.default.store.set(h.MetaCacheKey, {
                        nick: _.nick,
                        link: _.link,
                        mail: _.mail,
                      });
                    ...
                    try {
                      ...
                      : (Number(n.text()) ?
                        ...
                        e.$loading.hide(),
                        e.reset(),
                        'onCommentSubmitted' in e.cfg &&
                          k.default.isFunction(
                            e.cfg.onCommentSubmitted,
                          ) &&
                          e.cfg.onCommentSubmitted(_));
                    } catch (t) {
    ...
    function (e, t, n) {
      ...
      ((f.code = function (e, t) {
        ...
        i.marked.setOptions({
          renderer:
            'hljs' in window ? f : new i.marked.Renderer(),
      ...
      var r = n(2),
        ...
        a = function (e, t) {
          ...
          : i.default
              .ajax({
                url:
                  'https://api.qjqq.cn/api/qqinfo?qq=' + e,
                method: 'get',
              })
              .then(function (e) {
                return e.json();
        ...
        u = function (e) {
          i.default
            .ajax({
              url:
                '//pubstatic.b0.upaiyun.com/?_upnode&t=' +
                Date.now(),
              method: 'get',
            })
            .then(function (e) {
      ...
      var r = function (e) {
        ...
        i = function e(t) {
          return (
            ...
            : !isNaN(t) || /^\d+$/.test(t) ?
              new Date(parseInt(t))
            : /GMT/.test(t || '') ? e(new Date(t).getTime())
            : ((t = (t || '')
                .replace(/(^\s*)|(\s*$)/g, '')
                .replace(/\.\d+/, '')
                .replace(/-/, '/')
    ...
    function (e, t, n) {
      ...
      function l(e, t) {
        ...
        if (2 === n.length && 'string' == typeof e) {
          ...
          t &&
            i(t) &&
            ((a = null), (a = t(e, d.get(e))), l.set(e, a));
        }
        if (2 === n.length && o(e) && i(t))
          for (var u = 0, c = e.length; u < c; u++)
            ((a = t(e[u], d.get(e[u]))), l.set(e[u], a));
        return l;
      }
      t.__esModule = !0;
    ...
    function (e, t, n) {
      ...
      function o(e) {
        ((e = i(e || {})),
          ...
          (e.onIgnoreAttr =
            e.onIgnoreAttr || a.onIgnoreAttr),
          (e.safeAttrValue =
            e.safeAttrValue || a.safeAttrValue),
          (this.options = e));
      }
      var a = n(11),
        u = n(40);
      ...
      ((o.prototype.process = function (e) {
        ...
        return u(e, function (e, t, n, u, l) {
          ...
          if (
            (!0 === c ? (d = c)
            : 'function' == typeof c ? (d = c(u))
            : c instanceof RegExp && (d = c.test(u)),
            !0 !== d && (d = !1),
            (u = s(n, u)))
          ) {
            var p = {
      ...
      !(function (e, n) {
        ...
        function F(e, t) {
          return function (n, i, o) {
            ...
            if (
              (y(i), i.hooks && (i.hooks.options = i), o)
            ) {
              var s,
                l = i.highlight;
              try {
              ...
              var c = function (e) {
                ...
                if (!e)
                  try {
                    (i.walkTokens &&
                      C.walkTokens(s, i.walkTokens),
                      (n = t(s, i)),
                      i.hooks &&
                        (n = i.hooks.postprocess(n)));
                  } catch (t) {
                    e = t;
                  }
                return (
              ...
              if ((delete i.highlight, !s.length))
                return c();
              var d = 0;
              return (
                C.walkTokens(s, function (e) {
                  'code' === e.type &&
                    (d++,
                    setTimeout(function () {
            ...
            if (i.async)
              return Promise.resolve(
                i.hooks ? i.hooks.preprocess(n) : n,
              )
                .then(function (t) {
                  return e(t, i);
                })
            ...
            try {
              ...
              var f = t(p, i);
              return (
                i.hooks && (f = i.hooks.postprocess(f)),
                f
              );
            } catch (e) {
              return u(e);
                ...
                if (t) {
                  ...
                  if (n.header.length === n.align.length) {
                    ...
                    for (
                      ...
                      n.header[i].tokens =
                        this.lexer.inline(n.header[i].text);
                    for (
                      u = n.rows.length, i = 0;
                      i < u;
                      i++
        ...
        ((q._label = /(?!\s*\])(?:\\.|[^\[\]\\])+/),
          ...
          (q.gfm.table = f(q.gfm.table)
            ...
            .replace('tag', q._tag)
            .getRegex()),
          (q.gfm.paragraph = f(q._paragraph)
            .replace('hr', q.hr)
            .replace('heading', ' {0,3}#{1,6} ')
            .replace('|lheading', '')
          ...
          (q.pedantic = r({}, q.normal, {
            ...
            fences: Q,
            lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,
            paragraph: f(q.normal._paragraph)
              .replace('hr', q.hr)
              .replace('heading', ' *#{1,6} *[^\n]')
        ...
        ((V._punctuation =
          ...
          (V.blockSkip =
            /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
          (V.escapedEmSt = /(?:^|[^\\])(?:\\\\)*\\[*_]/g),
          (V._comment = f(q._comment)
            .replace('(?:--\x3e|$)', '--\x3e')
            .getRegex()),
          (V.emStrong.lDelim = f(V.emStrong.lDelim)
            .replace(/punct/g, V._punctuation)
            .getRegex()),
          (V.emStrong.rDelimAst = f(
            V.emStrong.rDelimAst,
            'g',
          )
            .replace(/punct/g, V._punctuation)
            .getRegex()),
          (V.emStrong.rDelimUnd = f(
            V.emStrong.rDelimUnd,
            'g',
          )
            .replace(/punct/g, V._punctuation)
            .getRegex()),
                ...
                for (; e; )
                  if (
                    ...
                    if ((r = this.tokenizer.escape(e)))
                      ...
                      (r = this.tokenizer.emStrong(e, l, s))
                    )
                      ((e = e.substring(r.raw.length)),
                        t.push(r));
                    else if (
                      ...
                      (r = this.tokenizer.autolink(e, A))
                    )
                      ((e = e.substring(r.raw.length)),
                        t.push(r));
                    else if (
                      this.state.inLink ||
                      !(r = this.tokenizer.url(e, A))
                    ) {
                      if (
                        ((o = e),
                        this.options.extensions &&
                ...
                switch (
                  ...
                  case 'table':
                    ...
                    for (
                      ...
                      for (
                        var c, d = s.value, p = a(d);
                        !(c = p()).done;
                      ) {
                        var f = c.value;
                        r = r.concat(
                          C.walkTokens(f.tokens, t),
                        );
                      }
                    break;
                  case 'list':
    ...
    function (e, t, n) {
      ...
      function u(e) {
        ((e = o(e || {})),
          ...
          (e.safeAttrValue =
            e.safeAttrValue || l.safeAttrValue),
      ...
      ((u.prototype.process = function (e) {
        ...
        n.stripIgnoreTagBody &&
          ((b = l.StripTagBody(n.stripIgnoreTagBody, u)),
          (u = b.onIgnoreTag));
        var y = d(
          e,
          function (e, t, n, l, d) {
